...
export const POST_PAYMENT_MOMO_SUCCESS = 'POST_PAYMENT_MOMO_SUCCESS';
export const POST_PAYMENT_MOMO_FAIL = 'POST_PAYMENT_MOMO_FAIL';

export const POST_PAYMENT_VNPAY_SUCCESS = 'POST_PAYMENT_VNPAY_SUCCESS';
export const POST_PAYMENT_VNPAY_FAIL = 'POST_PAYMENT_VNPAY_FAIL';
